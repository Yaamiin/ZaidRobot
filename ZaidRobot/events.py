...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import ZaidRobot.events

        path = Path(f"ZaidRobot/modules/{shortname}.py")
        name = "ZaidRobot.modules.{}".format(shortname)
        ...
        mod.ZaidRobot = ZaidRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["ZaidRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "ZaidRobot/modules/*.py"
